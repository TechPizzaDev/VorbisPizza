...
namespace NVorbis.Contracts
{
    ...
    public interface IVorbisReader : IDisposable
    {
        ...
        /// <summary>
        /// Gets the list of <see cref="IVorbisStreamDecoder"/> instances associated with the loaded file / container.
        /// </summary>
        IReadOnlyList<IVorbisStreamDecoder> Streams { get; }
        ...
        /// <returns>
        /// Whether if the properties of the logical stream differ from those of the one previously being decoded.
        /// </returns>
        ...
        /// <remarks>
        /// The data populated into <paramref name="buffer"/> is interleaved by channel in 
        /// normal PCM fashion: Left, Right, Left, Right, Left, Right.
        /// </remarks>
