namespace NVorbis.Contracts
{
    ...
    /// <param name="isFirst">
    /// <see langword="true"/> if the packet is the very first packet in the stream,
    /// otherwise <see langword="false"/>.
    /// </param>
    /// <returns>The calculated number of granules.</returns>
    public delegate int GetPacketGranuleCountDelegate(IPacket packet, bool isFirst);
    ...
    public interface IPacketProvider
    {
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="IPacket"/> instance for the next packet if available, 
        ...
        /// <summary>
        /// Seeks the stream to the packet that is prior to 
        /// the requested granule position by the specified preroll number of packets.
        /// </summary>
        ...
        /// A <see cref="GetPacketGranuleCountDelegate"/> delegate that 
        /// returns the number of granules in the specified packet.
        /// </param>
        /// <returns>The granule position at the start of the packet containing the requested position.</returns>
        long SeekTo(long granulePos, int preRoll, GetPacketGranuleCountDelegate getPacketGranuleCount);
